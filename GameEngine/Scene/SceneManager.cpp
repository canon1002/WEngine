...
#include "Editor/GlobalVariables.h"
...
#include "GameMaster/Framerate.h"
...
// 初期化
void SceneManager::Init(WinApp* winApp, DirectXCommon* dxCommon){
	// ポインタを取得
	winApp_ = winApp;
	mDxCommon = dxCommon;
	...
	//
	copyImage_ = PostEffects::GetInstance();
	copyImage_->Init(DirectXCommon::GetInstance(), MainCamera::GetInstance());
}
