...
Node ReadNode(aiNode* node) {
	...
	result.transform.scale = { scale.x,scale.y ,scale.z };// スケールはそのまま
	result.transform.rotation = { rotate.x,-rotate.y ,-rotate.z,rotate.w };// x軸を反転、更に回転方向が逆なので軸を反転させる
	result.transform.translation = { -translate.x,translate.y ,translate.z };// x軸を回転
