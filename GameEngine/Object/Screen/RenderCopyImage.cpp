...
PostEffects* PostEffects::instance = nullptr;

PostEffects* PostEffects::GetInstance()
{
	if (instance == nullptr) {
		instance = new PostEffects();
	}
	return instance;
}

void PostEffects::Finalize()
{
	delete instance;
	instance = nullptr;
}

void PostEffects::Init(DirectXCommon* dxCommon, Camera* camera) {
...
void PostEffects::CreateRootSignature(){
...
void PostEffects::CreateGraphicsPipeline(){
...
//
void PostEffects::CreateVertexResource() {
...
//
void PostEffects::CreateTransformation() {
...
//
void PostEffects::CreateBufferView() {
