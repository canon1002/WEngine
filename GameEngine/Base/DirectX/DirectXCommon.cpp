...
void DirectXCommon::Initialize(WinAPI* win) {
	...
	fence->SetName(L"DXCommon");
	graphicsPipelineState->SetName(L"DXCommon");
	rootSignature->SetName(L"DXCommon");
	result_->SetName(L"DXCommon");
	rtvDescriptorHeap->SetName(L"DXCommon");
	swapChainResources[0]->SetName(L"DXCommon");
	swapChainResources[1]->SetName(L"DXCommon");
	commandList->SetName(L"DXCommon");
	commandAllocator->SetName(L"DXCommon");
	commandQueue->SetName(L"DXCommon");
	//useAdapter_->Release();
	device_->SetName(L"DXCommon");
