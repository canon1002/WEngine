...
void GameScene::Update(){
	...
	case Phase::BEGIN:
		...
		// ビネットでフェードインする
		PostEffects::GetInstance()->SetViggnetIndex(ExponentialInterpolation(10.0f, 0.0f, viggnetTime, 1.0f));
	...
	case Phase::LOSE:
		...
		// ビネットでフェードインする
		PostEffects::GetInstance()->SetViggnetIndex(ExponentialInterpolation(00.0f, 10.0f, viggnetTime, 1.0f));
	...
	case Phase::WIN:
		...
		// ビネットでフェードインする
		PostEffects::GetInstance()->SetViggnetIndex(ExponentialInterpolation(0.0f, 10.0f, viggnetTime, 1.0f));
